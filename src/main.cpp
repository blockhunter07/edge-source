...
#if defined(NDEBUG)
# error "EDGE-VEXILLUM cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "EDGE-VEXILLUM Signed Message:\n";
...
{
    RenameThread("edge-vexillum-loadblk");
